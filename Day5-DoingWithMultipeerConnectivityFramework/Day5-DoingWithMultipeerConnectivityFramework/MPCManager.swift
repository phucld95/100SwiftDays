...
class MPCManager: NSObject, MCSessionDelegate, MCNearbyServiceBrowserDelegate, MCNearbyServiceAdvertiserDelegate {
    ...
    override init() {
        ...
        // Only apps regis with the same sevriteType can be see eath other.
        browser = MCNearbyServiceBrowser(peer: peer, serviceType: "lephucSV")
        browser.delegate = self
        
        advertiser = MCNearbyServiceAdvertiser(peer: peer, discoveryInfo: nil, serviceType: "lephucSV")
